...
To install a FIPS-compliant CockroachDB binary, refer to [Install a FIPS-compliant build of CockroachDB](fips-compliance.html). FIPS-compliant builds of CockroachDB are **experimental** and are not yet qualified for production use.
